...
public class IntrantThirdPersonAnimator : IntrantThirdPersonMotor
{
     #region Variables                
        ...
        public virtual void SetAnimatorToIdle()
        {
            if (animator == null || !animator.enabled) return;

            // Set the animator parameters to make the character transition to the idle animation
