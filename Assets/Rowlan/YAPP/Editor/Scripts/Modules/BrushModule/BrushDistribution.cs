...
namespace Rowlan.Yapp
{
    public class BrushDistribution
    {
        ...
        /// </summary>
        public void AddPrefabs_Poisson_Any(Vector3 position, Vector3 normal, bool forceNewDistribution, int density)
        {
            GameObject container = editorTarget.container as GameObject;
        ...
        /// Add prefabs, mode Poisson
        /// </summary>
        public void AddPrefabs_Poisson_Terrain(Vector3 position, Vector3 normal, bool forceNewDistribution, int density)
        {
