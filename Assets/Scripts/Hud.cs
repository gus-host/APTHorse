...
namespace Match3
{
    public class Hud : MonoBehaviour
    {
        ...
        public void OnGameWin(int score)
        {
            ...
            if (_starIndex > PlayerPrefs.GetInt(UnityEngine.SceneManagement.SceneManager.GetActiveScene().name, 0))
            {
                PlayerPrefs.SetInt(UnityEngine.SceneManagement.SceneManager.GetActiveScene().name, _starIndex);
            }
        }
